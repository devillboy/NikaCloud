    ...
    >
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="space-y-6 text-slate-400 text-lg leading-relaxed">
        ...
        <div className="bg-slate-900 p-6 rounded-xl border border-slate-800">
          ...
          <a href="https://discord.gg/nikacloud" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 bg-brand-blue text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-600 transition-colors">Join Discord & Open Ticket</a>
        </div>
        <p>For non-urgent inquiries, you can also reach us at <a href="mailto:support@nikacloud.in" className="text-brand-blue hover:underline">support@nikacloud.in</a>.</p>
      </motion.div>
    </motion.div>
  );
}
