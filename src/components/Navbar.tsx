          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/admin">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/10 text-sm font-medium transition-colors"
              >
      ...
      {isOpen && (
        ...
        >
          <div className="px-4 pt-2 pb-6 space-y-4 flex flex-col">
            ...
            <Link to="/admin" onClick={() => setIsOpen(false)} className="flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-brand-blue to-brand-purple text-white font-medium">
